	    ...
	    public static void main( String[] args ) throws IOException, SQLException
	    {
	   	...
	   	try {
	   		br=new BufferedReader(new InputStreamReader(System.in));
				...
				dao = context.getBean("dao", CustomerDao.class);
	   	...
	   	do {
	   		...
	   		switch (choice) {
				case 1:
					...
					uId=arr[0]+arr[1];
					dao.createCustomer(new Customer(uId, firstName, lastName, email));
					break;
				case 2:
					List<Customer> l=dao.getAllCustomers();
					System.out.format("%-20s%-20s%-20s%-20s\n", "uID","FIRST_NAME","LAST_NAME","EMIL");
					l.forEach(c->{
