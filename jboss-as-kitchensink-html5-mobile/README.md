jboss-as-kitchensink-html5-mobile: Example Application Using Multiple HTML5, Mobile & JAX-RS Technologies 
=========================================================================================================
Author: Jay Balunas
Level: Beginner 
Technologies: CDI, HTML5, REST, JPA
Summary: Based on jboss-as-kitchensink-html5-mobile, but uses HTML5, making it suitable for mobile and tablet computers
